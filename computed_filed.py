...
def insert_patient(patient: Patient):
    ...
    print(f"Inserting patient: {patient.name}, Age: {patient.age}, Email: {patient.email}, Height: {patient.height}, Weight: {patient.weight}, Contact: {patient.contact_info}" )

patient_info = { 'name': 'Parveen', 'age': 20, 'email': 'pks@iitm.com', 'height': 5.5, 'weight': 60.0,  'contact_info': {'phone': '123-456-7890', 'email':'abbb@iitm.com'} }
